...
export default function CreateAccountPage() {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        const wasBusinessOwner = formData.isBusinessOwner;
        ...
        try {
            const accountCreated = await createAccount({
                ...
                email: trimmedEmail,
                password: formData.password,
                isBusinessOwner: wasBusinessOwner,
            });
            ...
            const fullUser = await getUserByUsername(trimmedUsername);
                ...
                <div className="mx-10 md:mx-40 lg:mx-110 p-8 bg-[#484848] text-white rounded-lg mt-15">
                    ...
                    <div className="flex flex-col items-center mt-6">
                        ...
                        <form onSubmit={handleSubmit} className="w-full space-y-4">
                            ...
                            <Button
                                color={"#C95A23"}
                                className="w-full bg-[#C95A23] h-15 border-none text-black py-1 text-xl"
                                type="submit"
                                disabled={isLoading}
                            >
                                {isLoading ? "Creating..." : "Create Account"}
                            ...
                            <a href="../LoginUser">
                                <p className="hover:underline mt-5 text-blue-400 mx-auto">
