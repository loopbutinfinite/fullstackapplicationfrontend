...
import { getAllBusinesses, getBusinessById } from "@/data/lib//business-services";
...
// Working code backup before implementing categories 
// 'use client';
...
//                 </div>
//                 <div className='bg-[#C95A23]'>
//                   <p className='py-2 text-center font-bold'>Chinese</p>
//                 </div>
//                 <div className='bg-[#C95A23]'>
//                   <p className='py-2 text-center font-bold'>American</p>
//                 </div>
//               </div>
//             </Dropdown>
//             <Badge size="xl" color='#C95A23' className="justify-center px-6 py-2 bg-[#C95A23] text-white border-none rounded-lg text-[32px] mx-auto">
...
//This section is me working with trying to get the slugging to work when user clicks on a business from the homepage.
// 'use client';
...
// import { getAllBusinesses, getBusinessById } from "@/data/lib//business-services";
// import { BusinessModel } from '@/data/Interfaces/Interfaces';
// import { IsTokenValid } from '@/data/lib/user-services';
...
//             <Dropdown label="Category" color="#2D2D2D" size="md" className='bg-[#2D2D2D] text-xl'>
//               <div className='grid grid-rows-auto gap-2 bg-[#2D2D2D]'>
//                 <div className='bg-[#C95A23] rounded-md'>
//                   <DropdownItem className='py-2 text-xl font-bold'>Mexican</DropdownItem>
//                 </div>
//                 <div className='bg-[#C95A23] rounded-md'>
//                   <DropdownItem className='py-2 text-xl font-bold'>Korean</DropdownItem>
//                 </div>
//               </div>
//             </Dropdown>
//             <Badge size="xl" color='#C95A23' className="justify-center px-6 py-2 bg-[#C95A23] text-white border-none rounded-lg text-[32px] mx-auto">
...
//             {
//               businesses.map((business, index) => (
//                 <Card onClick={() => push(`/Business/${business.businessId}`)} key={index} color='#2D2D2D' className="dark:bg-[#2D2D2D] border-none hover:cursor-pointer">
//                   <div className="flex flex-col sm:flex-row gap-5 bg-[#2D2D2D]">
//                     <div className="w-full sm:w-32 h-32 rounded-lg flex items-center justify-center">
//                       <Image src="/assets/mexican-food-stock-image.jpg" className="mx-auto" width={180} height={180} alt={"Munchr Logo"}></Image>
//                     </div>
